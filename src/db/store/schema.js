...
export const product = store.table('product', {
	...
	warehouse_4: PG_DECIMAL('warehouse_4').default(0),
	warehouse_5: PG_DECIMAL('warehouse_5').default(0),
	warehouse_6: PG_DECIMAL('warehouse_6').default(0),
	warehouse_7: PG_DECIMAL('warehouse_7').default(0),
	warehouse_8: PG_DECIMAL('warehouse_8').default(0),
	warehouse_9: PG_DECIMAL('warehouse_9').default(0),
	warehouse_10: PG_DECIMAL('warehouse_10').default(0),
	warehouse_11: PG_DECIMAL('warehouse_11').default(0),
	warehouse_12: PG_DECIMAL('warehouse_12').default(0),
});
